...
class form {
	 ...
	 * @param string $catid
	 * @param string $color
	 * @param number $allowupload
	 * @param number $allowbrowser
	 * @param string $alowuploadexts
	 * @param number $height
	 * @param number $disabled_page
	 * @param string $allowuploadnum
	 */
	public static function editor2($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '',$height = 200,$disabled_page = 0, $allowuploadnum = '10') {
		$str ='';
		if(!defined('EDITOR_INIT')) {
